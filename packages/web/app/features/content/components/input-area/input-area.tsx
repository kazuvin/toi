import { Upload, Globe, Youtube } from "lucide-react";
...
export function InputArea({
  ...
  const renderInputArea = () => {
    switch (inputMethod) {
      case "text":
        return (
          <div className="w-full h-48 rounded-lg border border-gray-200 bg-white/90 backdrop-blur-sm shadow-sm overflow-hidden">
            <textarea
              placeholder="学習したい内容を入力してください..."
              className="w-full h-full p-6 resize-none focus:outline-none text-gray-700 placeholder-gray-400 bg-transparent"
              value={inputText}
